...
class BuildingRequeriment extends StatefulWidget {
  final String nameofProject;
  const BuildingRequeriment({Key? key, required this.nameofProject}) : super(key: key);

  @override
  State<BuildingRequeriment> createState() => _BuildingRequerimentState();
}

class _BuildingRequerimentState extends State<BuildingRequeriment> {
