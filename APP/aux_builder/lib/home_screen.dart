  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: Drawer(
        ...
        child: ListView(
          children: <Widget>[
            NavigatorButtons().navigator(context, '/project_screen', 'tela de projetos'),
            NavigatorButtons().navigator(context, '/planning/details_project', 'detalhes do projeto'),
            NavigatorButtons().navigator(context, '/planning/client_contract_screen', 'cliente e contrato'),
          ],
        ),
      ),
      appBar: AppBar(
